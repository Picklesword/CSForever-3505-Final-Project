...
namespace SpreadsheetGUITester
{
    ...
    public partial class UIMap
    {
        ...
        public void Open_Demo_Xml()
        {
            ...
            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
            //ApplicationUnderTest uISpreadsheetAppWindow =(this.Open_Demo_XmlParams.UISpreadsheetAppWindowExePath, this.Open_Demo_XmlParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Click 'file' -> 'Open' menu item
        ...
        public void Must_press_enter()
        {
            ...
            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
            //ApplicationUnderTest uISpreadsheetAppWindow =(this.Must_press_enterParams.UISpreadsheetAppWindowExePath, this.Must_press_enterParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
        ...
        /// <summary>
        /// shows go to bar works
        /// </summary>
        public void Go_To_Works()
        {
            #region Variable Declarations
            WinEdit uIGo_to_CellEdit = this.UISpreadsheetAppWindow.UIGo_to_CellWindow.UIGo_to_CellEdit;
            #endregion
            ...
            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
            //ApplicationUnderTest uISpreadsheetAppWindow = ApplicationUnderTest.Launch(this.Go_To_WorksParams.UISpreadsheetAppWindowExePath, this.Go_To_WorksParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Type 'b2' in 'Go_to_Cell' text box
            uIGo_to_CellEdit.Text = this.Go_To_WorksParams.UIGo_to_CellEditText;

            // Type '{Enter}' in 'Go_to_Cell' text box
            Keyboard.SendKeys(uIGo_to_CellEdit, this.Go_To_WorksParams.UIGo_to_CellEditSendKeys, ModifierKeys.None);

            // Type 'b22' in 'Go_to_Cell' text box
            uIGo_to_CellEdit.Text = this.Go_To_WorksParams.UIGo_to_CellEditText1;

            // Type '{Enter}' in 'Go_to_Cell' text box
            Keyboard.SendKeys(uIGo_to_CellEdit, this.Go_To_WorksParams.UIGo_to_CellEditSendKeys1, ModifierKeys.None);
        }
        
        /// <summary>
        /// shows that goto will not work with improper input
        /// </summary>
        public void Go_To_Failed()
        {
            #region Variable Declarations
            WinEdit uIGo_to_CellEdit = this.UISpreadsheetAppWindow.UIGo_to_CellWindow.UIGo_to_CellEdit;
            WinButton uIOKButton = this.UIPossibleDatalossWindow.UICancelWindow.UIOKButton;
            ...
            // Type '100' in 'Go_to_Cell' text box
            uIGo_to_CellEdit.Text = this.Go_To_FailedParams.UIGo_to_CellEditText;

            // Type '{Enter}' in 'Go_to_Cell' text box
            Keyboard.SendKeys(uIGo_to_CellEdit, this.Go_To_FailedParams.UIGo_to_CellEditSendKeys, ModifierKeys.None);

            // Click 'OK' button
            Mouse.Click(uIOKButton, new Point(63, 12));
        }
        
        /// <summary>
        /// Showed_another_bug - Use 'Showed_another_bugParams' to pass parameters into this method.
        /// </summary>
        public void Showed_another_bug()
        {
            #region Variable Declarations
            WinMenuItem uIFileMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem;
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinMenuBar uIMenuBarMenuBar = this.UISpreadsheetAppWindow.UIMenuStrip1Window.UIMenuBarMenuBar;
            WinMenuItem uISaveMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UISaveMenuItem;
            WinComboBox uIFilenameComboBox = this.UISaveAsWindow.UIDetailsPanePane.UIFilenameComboBox;
            WinButton uISaveButton = this.UISaveAsWindow.UISaveWindow.UISaveButton;
            ...
            // Click 'file' menu item
            Mouse.Click(uIFileMenuItem, new Point(15, 10));

            // Type '22' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.Showed_another_bugParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.Showed_another_bugParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'MenuBar' menu bar
            Mouse.Click(uIMenuBarMenuBar, new Point(20, 1));

            // Click 'file' -> 'Save' menu item
            Mouse.Click(uISaveMenuItem, new Point(57, 15));

            // Select 'some file' in 'File name:' combo box
            uIFilenameComboBox.EditableItem = this.Showed_another_bugParams.UIFilenameComboBoxEditableItem;

            // Click '&Save' button
            Mouse.Click(uISaveButton, new Point(44, 12));

            // Click 'file' -> 'Save' menu item
            Mouse.Click(uISaveMenuItem, new Point(52, 5));

            // Click '&Save' button
            Mouse.Click(uISaveButton, new Point(33, 15));

            // Click '&No' button
            Mouse.Click(uINOButton, new Point(40, 10));
        ...
        /// <summary>
        /// tested cancel and no save warning
        /// </summary>
        public void Exit_NoSave_Cancel()
        {
            #region Variable Declarations
            WinClient uIGUICellsClient = this.UISpreadsheetAppWindow.UIItemWindow.UIGUICellsClient;
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinButton uICloseButton = this.UISpreadsheetAppWindow.UISpreadsheetAppTitleBar.UICloseButton;
            WinButton uICancelButton = this.UIPossibleDatalossWindow.UICancelWindow.UICancelButton;
            #endregion

            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
           // ApplicationUnderTest uISpreadsheetAppWindow = ApplicationUnderTest.Launch(this.Exit_NoSave_CancelParams.UISpreadsheetAppWindowExePath, this.Exit_NoSave_CancelParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Click 'GUICells' client
            Mouse.Click(uIGUICellsClient, new Point(152, 70));

            // Type 'ice' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.Exit_NoSave_CancelParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.Exit_NoSave_CancelParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'Close' button
            Mouse.Click(uICloseButton, new Point(22, 6));

            // Click 'Cancel' button
            Mouse.Click(uICancelButton, new Point(66, 15));
        }
        
        /// <summary>
        /// shows saving on exit
        /// </summary>
        public void Exit_Save()
        {
            ...
            // Click '&Yes' button
            Mouse.Click(uIYesButton, new Point(60, 12));

            // Select 'lets save' in 'File name:' combo box
            uIFilenameComboBox.EditableItem = this.Exit_SaveParams.UIFilenameComboBoxEditableItem;
        ...
        /// <summary>
        /// created a scond gui then chose not to save
        /// </summary>
        public void Exit_Save_Cancel()
        {
            #region Variable Declarations
            WinMenuItem uINewMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UINewMenuItem;
            WinClient uIGUICellsClient = this.UISpreadsheetAppWindow1.UIItemWindow.UIGUICellsClient;
            WinWindow uICell_ContentsWindow = this.UISpreadsheetAppWindow1.UIPanel1Window.UICell_ContentsWindow;
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow1.UICell_ContentsWindow.UICell_ContentsEdit;
            WinButton uICloseButton = this.UISpreadsheetAppWindow1.UISpreadsheetAppTitleBar.UICloseButton;
            WinButton uIYesButton = this.UIPossibleDatalossWindow.UIYesWindow.UIYesButton;
            WinButton uICancelButton = this.UISaveAsWindow.UICancelWindow.UICancelButton;
            ...
            // Click 'file' -> 'New' menu item
            Mouse.Click(uINewMenuItem, new Point(36, 3));

            // Click 'GUICells' client
            Mouse.Click(uIGUICellsClient, new Point(143, 58));

            // Click 'Cell_Contents' window
            Mouse.Click(uICell_ContentsWindow, new Point(52, 0));

            // Type 'ice' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.Exit_Save_CancelParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.Exit_Save_CancelParams.UICell_ContentsEditSendKeys, ModifierKeys.None);
            ...
            // Click 'Cancel' button
            Mouse.Click(uICancelButton, new Point(27, 11));
        }
        
        /// <summary>
        /// Showed choosing not to save
        /// </summary>
        public void No_Save()
        {
            #region Variable Declarations
            WinButton uICloseButton = this.UISpreadsheetAppWindow1.UISpreadsheetAppTitleBar.UICloseButton;
            WinButton uINOButton = this.UIPossibleDatalossWindow.UINOWindow.UINOButton;
            #endregion

            // Click 'Close' button
            Mouse.Click(uICloseButton, new Point(12, 12));

            // Click '&No' button
            Mouse.Click(uINOButton, new Point(42, 11));
        }
        
        /// <summary>
        /// Skip_this_test - Use 'Skip_this_testParams' to pass parameters into this method.
        /// </summary>
        public void Skip_this_test()
        {

            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
           //ApplicationUnderTest spreadsheetGUIApplication = ApplicationUnderTest.Launch(this.Skip_this_testParams.ExePath, this.Skip_this_testParams.AlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
        }
        
        /// <summary>
        /// Skip_those_two - Use 'Skip_those_twoParams' to pass parameters into this method.
        /// </summary>
        public void Skip_those_two()
        {
            #region Variable Declarations
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinMenuItem uIOpenMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UIOpenMenuItem;
            ...
            WinButton uICancelButton = this.UISaveAsWindow.UICancelWindow.UICancelButton;
            WinButton uICloseButton = this.UISpreadsheetAppWindow.UISpreadsheetAppTitleBar.UICloseButton;
            WinButton uINOButton1 = this.UIPossibleDatalossWindow.UINOWindow.UINOButton;
            #endregion

            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
           // ApplicationUnderTest uISpreadsheetAppWindow = ApplicationUnderTest.Launch(this.Skip_those_twoParams.UISpreadsheetAppWindowExePath, this.Skip_those_twoParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Type 'ice' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.Skip_those_twoParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.Skip_those_twoParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'file' -> 'Open' menu item
            Mouse.Click(uIOpenMenuItem, new Point(81, 7));

            // Click '&Yes' button
            Mouse.Click(uIYesButton, new Point(53, 9));

            // Select 'lets save' in 'File name:' combo box
            uIFilenameComboBox.EditableItem = this.Skip_those_twoParams.UIFilenameComboBoxEditableItem;

            // Click '&Save' button
            Mouse.Click(uISaveButton, new Point(47, 12));

            // Click '&No' button
            Mouse.Click(uINOButton, new Point(29, 14));

            // Click 'Cancel' button
            Mouse.Click(uICancelButton, new Point(65, 18));

            // Click 'Close' button
            Mouse.Click(uICloseButton, new Point(21, 0));

            // Click '&No' button
            Mouse.Click(uINOButton1, new Point(68, 17));
        }
        
        /// <summary>
        /// saved before opening a file
        /// </summary>
        public void Save_before_open()
        {
            #region Variable Declarations
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinMenuItem uIOpenMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UIOpenMenuItem;
            ...
            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
            //ApplicationUnderTest uISpreadsheetAppWindow = ApplicationUnderTest.Launch(this.Save_before_openParams.UISpreadsheetAppWindowExePath, this.Save_before_openParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Type 'ice' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.Save_before_openParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.Save_before_openParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'file' -> 'Open' menu item
            Mouse.Click(uIOpenMenuItem, new Point(65, 3));

            // Click '&Yes' button
            Mouse.Click(uIYesButton, new Point(70, 13));

            // Select 'does not exist' in 'File name:' combo box
            uIFilenameComboBox.EditableItem = this.Save_before_openParams.UIFilenameComboBoxEditableItem;

            // Click '&Save' button
            Mouse.Click(uISaveButton, new Point(56, 12));
        }
        
        /// <summary>
        /// another_overwrite_attempt - Use 'another_overwrite_attemptParams' to pass parameters into this method.
        /// </summary>
        public void another_overwrite_attempt()
        {
            #region Variable Declarations
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinMenuItem uIOpenMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UIOpenMenuItem;
            ...
            // Type 'c#' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.another_overwrite_attemptParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.another_overwrite_attemptParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'file' -> 'Open' menu item
            Mouse.Click(uIOpenMenuItem, new Point(56, 11));
        ...
        /// <summary>
        /// attmpts to perserve_data
        /// </summary>
        public void attempt_to_perserve_data()
        {
            #region Variable Declarations
            WinEdit uICell_ContentsEdit = this.UISpreadsheetAppWindow.UICell_ContentsWindow.UICell_ContentsEdit;
            WinMenuItem uIOpenMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UIOpenMenuItem;
            ...
            // Type 'c##' in 'Cell_Contents' text box
            uICell_ContentsEdit.Text = this.attempt_to_perserve_dataParams.UICell_ContentsEditText;

            // Type '{Enter}' in 'Cell_Contents' text box
            Keyboard.SendKeys(uICell_ContentsEdit, this.attempt_to_perserve_dataParams.UICell_ContentsEditSendKeys, ModifierKeys.None);

            // Click 'file' -> 'Open' menu item
            Mouse.Click(uIOpenMenuItem, new Point(68, 10));

            // Click '&No' button
            Mouse.Click(uINOButton, new Point(57, 4));

            // Click 'Cancel' button
            Mouse.Click(uICancelButton, new Point(55, 13));

            // Click 'Close' button
            Mouse.Click(uICloseButton, new Point(21, 11));

            // Click '&No' button
            Mouse.Click(uINOButton, new Point(19, 7));
        }
        
        /// <summary>
        /// shows can't read broken file
        /// </summary>
        public void Cant_read_broken_file()
        {
            #region Variable Declarations
            WinMenuItem uIOpenMenuItem = this.UISpreadsheetAppWindow.UIMenuBarMenuBar.UIFileMenuItem.UIOpenMenuItem;
            WinComboBox uIFilesoftypeComboBox = this.UIOpenWindow.UIItemWindow4.UIFilesoftypeComboBox;
            WinEdit uINameEdit = this.UIOpenWindow.UIItemWindow.UIDemo_brokeListItem.UINameEdit;
            WinButton uIOKButton = this.UIOpenFailedWindow.UIOKWindow.UIOKButton;
            #endregion

            // Launch '%USERPROFILE%\Documents\Visual Studio 2013\Projects\PS6\SpreadsheetGUI\bin\Debug\SpreadsheetGUI.exe'
            //ApplicationUnderTest uISpreadsheetAppWindow = ApplicationUnderTest.Launch(this.Cant_read_broken_fileParams.UISpreadsheetAppWindowExePath, this.Cant_read_broken_fileParams.UISpreadsheetAppWindowAlternateExePath);
            ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
            // Click 'file' -> 'Open' menu item
            Mouse.Click(uIOpenMenuItem, new Point(47, 8));

            // Select 'All Files (*.*)' in 'Files of type:' combo box
            uIFilesoftypeComboBox.SelectedItem = this.Cant_read_broken_fileParams.UIFilesoftypeComboBoxSelectedItem;

            // Double-Click 'Name' text box
            Mouse.DoubleClick(uINameEdit, new Point(60, 12));
        ...
        public virtual Go_To_WorksParams Go_To_WorksParams
        {
            get
            {
                if ((this.mGo_To_WorksParams == null))
                {
                    this.mGo_To_WorksParams = new Go_To_WorksParams();
                }
                return this.mGo_To_WorksParams;
            }
        }
        
        public virtual Go_To_FailedParams Go_To_FailedParams
        {
            get
            {
                if ((this.mGo_To_FailedParams == null))
                {
                    this.mGo_To_FailedParams = new Go_To_FailedParams();
                }
                return this.mGo_To_FailedParams;
            }
        }
        
        public virtual Showed_another_bugParams Showed_another_bugParams
        {
            get
            {
                if ((this.mShowed_another_bugParams == null))
                {
                    this.mShowed_another_bugParams = new Showed_another_bugParams();
                }
                return this.mShowed_another_bugParams;
            }
        }
        
        public virtual Exit_NoSave_CancelParams Exit_NoSave_CancelParams
        {
            get
            {
                if ((this.mExit_NoSave_CancelParams == null))
                {
                    this.mExit_NoSave_CancelParams = new Exit_NoSave_CancelParams();
                }
                return this.mExit_NoSave_CancelParams;
            }
        }
        
        public virtual Exit_SaveParams Exit_SaveParams
        {
            get
            {
                if ((this.mExit_SaveParams == null))
                {
                    this.mExit_SaveParams = new Exit_SaveParams();
                }
                return this.mExit_SaveParams;
            }
        }
        
        public virtual Exit_Save_CancelParams Exit_Save_CancelParams
        {
            get
            {
                if ((this.mExit_Save_CancelParams == null))
                {
                    this.mExit_Save_CancelParams = new Exit_Save_CancelParams();
                }
                return this.mExit_Save_CancelParams;
            }
        }
        
        public virtual Skip_this_testParams Skip_this_testParams
        {
            get
            {
                if ((this.mSkip_this_testParams == null))
                {
                    this.mSkip_this_testParams = new Skip_this_testParams();
                }
                return this.mSkip_this_testParams;
            }
        }
        
        public virtual Skip_those_twoParams Skip_those_twoParams
        {
            get
            {
                if ((this.mSkip_those_twoParams == null))
                {
                    this.mSkip_those_twoParams = new Skip_those_twoParams();
                }
                return this.mSkip_those_twoParams;
            }
        }
        
        public virtual Save_before_openParams Save_before_openParams
        {
            get
            {
                if ((this.mSave_before_openParams == null))
                {
                    this.mSave_before_openParams = new Save_before_openParams();
                }
                return this.mSave_before_openParams;
            }
        }
        
        public virtual another_overwrite_attemptParams another_overwrite_attemptParams
        {
            get
            {
                if ((this.manother_overwrite_attemptParams == null))
                {
                    this.manother_overwrite_attemptParams = new another_overwrite_attemptParams();
                }
                return this.manother_overwrite_attemptParams;
            }
        }
        
        public virtual attempt_to_perserve_dataParams attempt_to_perserve_dataParams
        {
            get
            {
                if ((this.mattempt_to_perserve_dataParams == null))
                {
                    this.mattempt_to_perserve_dataParams = new attempt_to_perserve_dataParams();
                }
                return this.mattempt_to_perserve_dataParams;
            }
        }
        
        public virtual Cant_read_broken_fileParams Cant_read_broken_fileParams
        {
            get
            {
                if ((this.mCant_read_broken_fileParams == null))
                {
                    this.mCant_read_broken_fileParams = new Cant_read_broken_fileParams();
                }
                return this.mCant_read_broken_fileParams;
            }
        }
        ...
        public UIOpenFailedWindow UIOpenFailedWindow
        {
            get
            {
                if ((this.mUIOpenFailedWindow == null))
                {
                    this.mUIOpenFailedWindow = new UIOpenFailedWindow();
                }
                return this.mUIOpenFailedWindow;
            }
        }
        #endregion
        ...
        private Go_To_WorksParams mGo_To_WorksParams;
        
        private Go_To_FailedParams mGo_To_FailedParams;
        
        private Showed_another_bugParams mShowed_another_bugParams;
        
        private Exit_NoSave_CancelParams mExit_NoSave_CancelParams;
        
        private Exit_SaveParams mExit_SaveParams;
        
        private Exit_Save_CancelParams mExit_Save_CancelParams;
        
        private Skip_this_testParams mSkip_this_testParams;
        
        private Skip_those_twoParams mSkip_those_twoParams;
        
        private Save_before_openParams mSave_before_openParams;
        
        private another_overwrite_attemptParams manother_overwrite_attemptParams;
        
        private attempt_to_perserve_dataParams mattempt_to_perserve_dataParams;
        
        private Cant_read_broken_fileParams mCant_read_broken_fileParams;
        ...
        private UIOpenFailedWindow mUIOpenFailedWindow;
        #endregion
    }
    ...
    /// <summary>
    /// Parameters to be passed into 'Go_To_Works'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Go_To_WorksParams
    {
        ...
        /// Type 'b2' in 'Go_to_Cell' text box
        /// </summary>
        public string UIGo_to_CellEditText = "b2";
        ...
        /// Type 'b22' in 'Go_to_Cell' text box
        /// </summary>
        public string UIGo_to_CellEditText1 = "b22";
        
        /// <summary>
        /// Type '{Enter}' in 'Go_to_Cell' text box
        /// </summary>
        public string UIGo_to_CellEditSendKeys1 = "{Enter}";
        #endregion
    }
    
    /// <summary>
    /// Parameters to be passed into 'Go_To_Failed'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Go_To_FailedParams
    {
        ...
        /// Type '100' in 'Go_to_Cell' text box
        /// </summary>
        public string UIGo_to_CellEditText = "100";
    ...
    /// <summary>
    /// Parameters to be passed into 'Showed_another_bug'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Showed_another_bugParams
    {
        ...
        /// Type '22' in 'Cell_Contents' text box
        /// </summary>
        public string UICell_ContentsEditText = "22";
        ...
        /// Select 'some file' in 'File name:' combo box
        /// </summary>
        public string UIFilenameComboBoxEditableItem = "some file";
        #endregion
    }
    
    /// <summary>
    /// Parameters to be passed into 'Exit_NoSave_Cancel'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Exit_NoSave_CancelParams
    {
        ...
        /// Type 'ice' in 'Cell_Contents' text box
        /// </summary>
        public string UICell_ContentsEditText = "ice";
    ...
    /// <summary>
    /// Parameters to be passed into 'Exit_Save'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Exit_SaveParams
    {
        ...
        /// Select 'lets save' in 'File name:' combo box
        /// </summary>
        public string UIFilenameComboBoxEditableItem = "lets save";
        #endregion
    }
    
    /// <summary>
    /// Parameters to be passed into 'Exit_Save_Cancel'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Exit_Save_CancelParams
    {
    ...
    /// <summary>
    /// Parameters to be passed into 'Skip_this_test'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Skip_this_testParams
    {
    ...
    /// <summary>
    /// Parameters to be passed into 'Skip_those_two'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Skip_those_twoParams
    {
    ...
    /// <summary>
    /// Parameters to be passed into 'Save_before_open'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Save_before_openParams
    {
        ...
        /// Select 'does not exist' in 'File name:' combo box
        /// </summary>
        public string UIFilenameComboBoxEditableItem = "does not exist";
        #endregion
    }
    
    /// <summary>
    /// Parameters to be passed into 'another_overwrite_attempt'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class another_overwrite_attemptParams
    {
        ...
        /// Type 'c#' in 'Cell_Contents' text box
        /// </summary>
        public string UICell_ContentsEditText = "c#";
    ...
    /// <summary>
    /// Parameters to be passed into 'attempt_to_perserve_data'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class attempt_to_perserve_dataParams
    {
    ...
    /// <summary>
    /// Parameters to be passed into 'Cant_read_broken_file'
    /// </summary>
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class Cant_read_broken_fileParams
    {
        ...
        public WinMenuItem UISaveMenuItem
        {
            get
            {
                if ((this.mUISaveMenuItem == null))
                {
                    ...
                    this.mUISaveMenuItem.WindowTitles.Add("Spreadsheet App");
                    #endregion
                }
    ...
    public class UIMenuStrip1Window : WinWindow
    {
        ...
        {
            #region Search Criteria
            this.SearchProperties[WinWindow.PropertyNames.ControlName] = "MenuBar";
            this.WindowTitles.Add("Spreadsheet App");
            #endregion
        }
        
        #region Properties
        public WinMenuBar UIMenuBarMenuBar
        {
            get
            {
                if ((this.mUIMenuBarMenuBar == null))
                {
                    this.mUIMenuBarMenuBar = new WinMenuBar(this);
                    #region Search Criteria
                    this.mUIMenuBarMenuBar.SearchProperties[WinMenu.PropertyNames.Name] = "menuStrip1";
                    this.mUIMenuBarMenuBar.WindowTitles.Add("Spreadsheet App");
                    #endregion
                }
                return this.mUIMenuBarMenuBar;
            }
        ...
        #region Fields
        private WinMenuBar mUIMenuBarMenuBar;
        #endregion
    }
    ...
    public class UIPanel1Window : WinWindow
    {
        ...
        #region Properties
        public WinWindow UICell_ContentsWindow
        {
            get
            {
                if ((this.mUICell_ContentsWindow == null))
                {
                    this.mUICell_ContentsWindow = new WinWindow(this);
                    #region Search Criteria
                    this.mUICell_ContentsWindow.SearchProperties[WinWindow.PropertyNames.AccessibleName] = "Cell_Value";
                    this.mUICell_ContentsWindow.SearchProperties.Add(new PropertyExpression(WinWindow.PropertyNames.ClassName, "WindowsForms10.EDIT", PropertyExpressionOperator.Contains));
                    this.mUICell_ContentsWindow.WindowTitles.Add("Spreadsheet App");
                    #endregion
                }
                return this.mUICell_ContentsWindow;
            }
        ...
        #region Fields
        private WinWindow mUICell_ContentsWindow;
        #endregion
    }
    ...
    public class UISpreadsheetAppWindow3 : WinWindow
    {
        ...
        #region Properties
        public UISpreadsheetAppTitleBar3 UISpreadsheetAppTitleBar
        {
            get
            {
                if ((this.mUISpreadsheetAppTitleBar == null))
                {
                    this.mUISpreadsheetAppTitleBar = new UISpreadsheetAppTitleBar3(this);
                }
                return this.mUISpreadsheetAppTitleBar;
            }
        }
        ...
        #region Fields
        private UISpreadsheetAppTitleBar3 mUISpreadsheetAppTitleBar;
        #endregion
    }
    
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class UISpreadsheetAppTitleBar3 : WinTitleBar
    {
        
        public UISpreadsheetAppTitleBar3(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region Search Criteria
            this.WindowTitles.Add("Spreadsheet App");
        ...
        public WinButton UINOButton
        {
            get
            {
                if ((this.mUINOButton == null))
                {
                    ...
                    this.mUINOButton.WindowTitles.Add("Possible Dataloss");
                    #endregion
                }
    ...
    public class UIItemWindow2 : WinWindow
    {
        ...
        public UIDemo_brokeListItem UIDemo_brokeListItem
        {
            get
            {
                if ((this.mUIDemo_brokeListItem == null))
                {
                    this.mUIDemo_brokeListItem = new UIDemo_brokeListItem(this);
                }
                return this.mUIDemo_brokeListItem;
            }
        }
        #endregion
        ...
        private UIDemo_brokeListItem mUIDemo_brokeListItem;
        #endregion
    }
    ...
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class UIDemo_brokeListItem : WinListItem
    {
        
        public UIDemo_brokeListItem(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region Search Criteria
            this.SearchProperties[WinListItem.PropertyNames.Name] = "demo_broke";
            this.WindowTitles.Add("Open");
            #endregion
        }
    ...
    [GeneratedCode("Coded UITest Builder", "12.0.30501.0")]
    public class UIOpenFailedWindow : WinWindow
    {
        
        public UIOpenFailedWindow()
        {
            #region Search Criteria
            this.SearchProperties[WinWindow.PropertyNames.Name] = "Open Failed";
            this.SearchProperties[WinWindow.PropertyNames.ClassName] = "#32770";
            this.WindowTitles.Add("Open Failed");
            #endregion
        }
        ...
        public WinButton UIOKButton
        {
            get
            {
                if ((this.mUIOKButton == null))
                {
                    ...
                    #region Search Criteria
                    this.mUIOKButton.SearchProperties[WinButton.PropertyNames.Name] = "OK";
                    this.mUIOKButton.WindowTitles.Add("Open Failed");
                    #endregion
                }
                return this.mUIOKButton;
            }
