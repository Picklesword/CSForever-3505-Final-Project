...
namespace SS
{
    ...
    public class Spreadsheet : AbstractSpreadsheet
    {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        private void UpdateDependeesOfString(ISet<string> list, string name)
        {
            ...
            foreach (string n in list)
            {
                ...
                if (/*counter == 1 || */(cellValues[n].CellContents is string) || cellValues[n].CellContents is Double)
        ...
        /// </summary>
        /// <param name="list"></param>
        private void UpdateCells(ISet<string> list, string name)
        {
            object cellContentVal = null;
            ...
            foreach (string n in list)
            {
                if (cellValues.ContainsKey(n))//makes sure the cellValues exists
                {
                    ...
                    if (cellContentVal is string) //if the input name is a string it calls the UpdateDependeesOfString
                        UpdateDependeesOfString(list, name);

                    else if (cellContentVal is Formula)
                    {
        ...
        protected override ISet<string> SetCellContents(string name, double number)
        {
           ...
           returnSet = GetCellsToRecalculate(name).ToHashSet<string>();//recalculates the values and checks for circular dependency
        ...
        protected override ISet<string> SetCellContents(string name, string text)
        {
            ...
            if (text.Equals(""))
            {
                returnSet = GetCellsToRecalculate(name).ToHashSet<string>();
        ...
        protected override ISet<string> SetCellContents(string name, Formula formula)
        {
            ...
            catch (CircularException c)
            {
                ...
                if (originalCellContent != null)
                {
                    ...
                    {
                        string recover = originalCellContent.ToString();
                        Formula originalFormula = new Formula(recover);
    ...
    {
        public static HashSet<String> ToHashSet<String>(this IEnumerable<String> source)
        {
